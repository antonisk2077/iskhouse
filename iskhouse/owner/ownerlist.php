...
$branch_filter_sql = ($filter_branch_id > 0) ? " where branch_id = " . $filter_branch_id : "";
...
<div class="row">
  <div class="col-xs-12">
    ...
    <div align="right" style="margin-bottom:1%;">
      ...
      <a class="btn btn-success" data-toggle="tooltip" href="<?php echo WEB_URL; ?>owner/addowner.php" data-original-title="<?php echo $_data['add_new_owner_breadcam'];?>"><i class="fa fa-plus"></i></a>
      ...
      <div class="box-body">
        <table class="table sakotable table-bordered table-striped dt-responsive">
          ...
          <tbody>
            <?php
				$_units = array();
				$result = mysqli_query($link,"Select * from tbl_add_owner".$branch_filter_sql." order by ownid desc");
