...
$branch_filter_sql = ($filter_branch_id > 0) ? " where u.branch_id = " . $filter_branch_id : "";
...
<div class="row">
  <div class="col-xs-12">
    ...
    <div align="right" style="margin-bottom:1%;">
      ...
      <a class="btn btn-success" data-toggle="tooltip" href="<?php echo WEB_URL; ?>unit/addunit.php" data-original-title="<?php echo $_data['add_unit'];?>"><i class="fa fa-plus"></i></a>
    ...
    <div class="box box-success">
      ...
      <div class="box-body">
        <table class="table sakotable table-bordered table-striped dt-responsive">
          ...
          <tbody>
            <?php
				$result = mysqli_query($link,"Select f.floor_no,u.unit_no,u.uid from tbl_add_unit u inner join tbl_add_floor f on f.fid = u.floor_no".$branch_filter_sql." order by u.uid ASC");
