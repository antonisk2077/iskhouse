...
$branch_filter_sql = ($filter_branch_id > 0) ? " and ou.branch_id = " . $filter_branch_id : "";
...
<div class="row">
  <div class="col-xs-12">
    ...
    <div align="right" style="margin-bottom:1%;">
      ...
      <a class="btn btn-success" data-toggle="tooltip" href="<?php echo WEB_URL; ?>owner_utility/add_owner_utility.php" data-original-title="<?php echo $_data['add_owner_utility'];?>"><i class="fa fa-plus"></i></a>
    ...
    <div class="box box-success">
      ...
      <div class="box-body">
        <table class="table sakotable table-bordered table-striped dt-responsive">
          ...
          <tbody>
        <?php
		$result = mysqli_query($link,"Select ou.*,m.month_name from tbl_add_fair ou left join tbl_add_month_setup m on m.m_id = ou.month_id where ou.type='Owner'".$branch_filter_sql." order by ou.f_id desc");
