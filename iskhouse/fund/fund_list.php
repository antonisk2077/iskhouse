...
$branch_filter_sql = ($filter_branch_id > 0) ? " where fu.branch_id = " . $filter_branch_id : "";
...
<div class="row">
  <div class="col-xs-12">
    ...
    <div align="right" style="margin-bottom:1%;">
      ...
      <a class="btn btn-success" data-toggle="tooltip" href="<?php echo WEB_URL; ?>fund/add_fund.php" data-original-title="<?php echo $_data['add_new_fund_breadcam'];?>"><i class="fa fa-plus"></i></a>
