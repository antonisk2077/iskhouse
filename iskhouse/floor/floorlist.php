...
<div class="row">
  <div class="col-xs-12">
    ...
    <div align="right" style="margin-bottom:1%;">
      ...
      <a class="btn btn-success" data-toggle="tooltip" href="<?php echo WEB_URL; ?>floor/addfloor.php" data-original-title="<?php echo $_data['add_floor'];?>"><i class="fa fa-plus"></i></a>
    ...
    <div class="box box-success">
      ...
      <div class="box-body">
        <table class="table sakotable table-bordered table-striped dt-responsive">
          ...
          <tbody>
        <?php
			$result = mysqli_query($link,"Select * from tbl_add_floor".$branch_filter_sql." order by fid DESC");
