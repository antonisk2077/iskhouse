...
$addinfo = 'none';
$msg = "";
$branch_filter = (int)$_SESSION['objLogin']['branch_id'];
    ...
    <div class="box box-success">
      ...
      <div class="box-body">
        <table class="table sakotable table-bordered table-striped dt-responsive">
          ...
          <tbody>
            <?php
				$list_sql = "Select *,fr.floor_no,u.unit_no from tbl_visitor v inner join tbl_add_floor fr on fr.fid = v.floor_id inner join tbl_add_unit u on u.uid = v.unit_id";
				if($branch_filter > 0){
					$list_sql .= " where v.branch_id = " . $branch_filter;
				}
				$list_sql .= " order by v.vid desc";
