...
$branch_filter_sql = ($filter_branch_id > 0) ? " where mc.branch_id = " . $filter_branch_id : "";
    ...
    <div class="row">
      <div class="col-xs-12">
        ...
        <div align="right" style="margin-bottom:1%;">
          ...
          <a class="btn btn-success" data-toggle="tooltip" href="<?php echo WEB_URL; ?>management/add_m_committee.php" data-original-title="<?php echo $_data['add_new_m_committee_breadcam'];?>"><i class="fa fa-plus"></i></a>
        ...
        <div class="box box-success">
          ...
          <div class="box-body">
            <table class="table sakotable table-bordered table-striped dt-responsive">
              ...
              <tbody>
                <?php
				$result = mysqli_query($link,"Select *,mt.member_type as mt_member_type from tbl_add_management_committee mc inner join tbl_add_member_type mt on mc.member_type = mt.member_id".$branch_filter_sql." order by mc.mc_id desc");
