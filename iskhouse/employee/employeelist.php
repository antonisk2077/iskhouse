...
$branch_filter_sql = ($filter_branch_id > 0) ? " and e.branch_id = " . $filter_branch_id : "";
...
<div class="row">
  <div class="col-xs-12">
    ...
    <div align="right" style="margin-bottom:1%;">
      ...
      <a class="btn btn-success" data-toggle="tooltip" href="<?php echo WEB_URL; ?>employee/addemployee.php" data-original-title="<?php echo $_data['add_new_employee_breadcam'];?>"><i class="fa fa-plus"></i></a>
    ...
    <div class="box box-success">
      ...
      <div class="box-body">
        <table class="table sakotable table-bordered table-striped dt-responsive">
          ...
          <tbody>
            <?php
				$result = mysqli_query($link,"SELECT *,mt.member_type FROM tbl_add_employee e inner join tbl_add_member_type mt where mt.member_id = e.e_designation".$branch_filter_sql);
