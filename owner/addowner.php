      ...
      <form onsubmit="return validateMe();" action="<?php echo $form_url; ?>" method="post" enctype="multipart/form-data" id="frm_owner_entry">
        <div class="box-body row">
          ...
          <div class="form-group col-md-6">
            ...
            <input type="email" name="txtOwnerEmail" value="<?php echo $o_email;?>" id="txtOwnerEmail" class="form-control"  />
          </div>
          <div class="form-group col-md-6">
...
function validateMe(){
	...
	// same yess? else if($("#txtOwnerEmail").val() == '' || !checkValidEmail('txtOwnerEmail')){
// Here Will not throw any error because we come, why dont you just command frome the begining of else if ?
// it's not important also this work 
